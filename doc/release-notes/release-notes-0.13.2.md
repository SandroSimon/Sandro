Sandrocoin Core version 0.13.2 is now available from:
  ...
  <https://sandrocoin.org/bin/sandrocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update sandrocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow sandrocoin-tx to create v2 transactions (btcdrak)
