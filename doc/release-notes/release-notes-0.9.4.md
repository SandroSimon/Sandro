Sandrocoin Core version 0.9.4 is now available from:

  https://sandrocoin.org/bin/0.9.4/
...
this update is incompatible with the Sandrocoin system and could lead to consensus
forks.

Sandrocoin Core released binaries from https://sandrocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sandrocoin/+archive/ubuntu/sandrocoin
- A third-party or self-compiled Sandrocoin Core

upgrade to Sandrocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
