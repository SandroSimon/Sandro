Sandrocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sandrocoin/files/Sandrocoin/sandrocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sandrocoin
...
New/changed settings (command-line or sandrocoin.conf file)
--------------------------------------------------------
