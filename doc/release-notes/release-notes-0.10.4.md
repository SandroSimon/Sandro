Sandrocoin Core version 0.10.4 is now available from:

  <https://sandrocoin.org/bin/sandrocoin-core-0.10.4/>
...
- #6953 `43c2789` Split sandrocoin-tx into its own package
- #6953 `dfe0d4d` Include sandrocoin-tx binary on Debian/Ubuntu
