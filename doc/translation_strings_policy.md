...
This document provides guidelines for internationalization of the Sandrocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sandrocoin_en.ts` remains unchanged.
