...
class RawTransactionsTest(SandrocoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid sandrocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid sandrocoin address" in e.error['message'])
