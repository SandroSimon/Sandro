...
#ifndef SANDROCOIN_WALLET_WALLET_H
#define SANDROCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this sandrocoin node, and set to 0 for transactions that were created
...
#endif // SANDROCOIN_WALLET_WALLET_H
