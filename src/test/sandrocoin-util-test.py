...
# Copyright 2016 The Sandrocoin Core developers
...
help_text="""Test framework for sandrocoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/sandrocoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "sandrocoin-util-test.json", buildenv)
