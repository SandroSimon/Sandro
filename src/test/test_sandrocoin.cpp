...
#define BOOST_TEST_MODULE Sandrocoin Test Suite

#include "test_sandrocoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sandrocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
