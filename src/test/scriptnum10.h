...
#ifndef SANDROCOIN_TEST_SCRIPTNUM10_H
#define SANDROCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sandrocoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SANDROCOIN_TEST_BIGNUM_H
