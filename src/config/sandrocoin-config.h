/* src/config/sandrocoin-config.h.  Generated from sandrocoin-config.h.in by configure.  */
/* src/config/sandrocoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SANDROCOIN_CONFIG_H

#define SANDROCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Sandrocoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Sandrocoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/sandrocoin-project/sandrocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sandrocoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sandrocoin Core 0.14.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sandrocoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sandrocoin.org/"
