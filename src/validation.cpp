...
#if defined(NDEBUG)
# error "Sandrocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sandrocoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s SND additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("sandrocoin-scriptch");
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Sandrocoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
